			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li><a href="adminprofile.jsp" class="waves-effect"><i
						...
						<li><a href="regstu.jsp" class="waves-effect"><i
								class="fa fa-table m-r-10" aria-hidden="true"></i>Registered Students</a></li>
						<li><a href="verstu.jsp" class="waves-effect"><i
								class="fa fa-table m-r-10" aria-hidden="true"></i>Verified Students</a></li>
