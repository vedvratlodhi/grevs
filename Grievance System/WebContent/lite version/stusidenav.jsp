<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
			...
			<a href="NewFile.jsp" class="btn btn-info" style="font-size:18px;">Logout</a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                          <li>
                            <a href="stuprofile.jsp" class="waves-effect"><i class="fa fa-user m-r-10" aria-hidden="true"></i>My Account</a>
                        </li>
                        <li>
                            <a href="viewGrievences.jsp" class="waves-effect"><i class="fa fa-table m-r-10" aria-hidden="true"></i>My Grievances</a>
                        </li>
                      <li>
                            <a href="submitgrievance.jsp" class="waves-effect"><i class="fa fa-font m-r-10" aria-hidden="true"></i>Post a Grievence</a>
                        </li>
                     <!--    <li>
